...
<div class="product-item card-product">
	<? if ($itemHasDetailUrl): ?>
	<a class="product-item-image-wrapper card-product__box" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>"
						...
						if (!$haveOffers)
						{
							if ($actualItem['CAN_BUY'])
							{
								...
								<div class="product-item-button-container" id="<?=$itemIds['BASKET_ACTIONS']?>">
									<button class="btn btn-primary <?=$buttonSizeClass?> basket_btn" id="<?=$itemIds['BUY_LINK']?>"
