    ...
    <div class="container">
        ...
        <div class="product-content">
            ...
            <div class="product-content__left">
                ...
                <div class="banner-product" id="<?=$itemIds['BIG_SLIDER_ID']?>">

                    <div class="card-product__stock" id="<?=$itemIds['STICKER_ID']?>" <?/*=(!$arResult['LABEL'] ? 'style="display: none;"' : '' )*/?>>
                    ...
                    <div class="swiper-container banner-product__big">
                        <div class="swiper-wrapper banner-product__big_wrapper">
                            ...
                            <div class="swiper-slide banner-product__big_slide <?=($key == 0 ? ' active' : '')?>" data-id="<?=$photo['ID']?>" data-entity="image">
                                <!--<div class="card-product__stock"></div>-->
                                <div class="banner-product__big_img">
                    ...
                    <div class="swiper-container banner-product__small">
                        ...
                        <? if ($showSliderControls) { ?>
                            ...
                            <div class="swiper-slide banner-product__small_slide" id="<?=$itemIds['SLIDER_CONT_OF_ID'].$offer['ID']?>" style="display: <?=$strVisible?>;">
                                <div class="d<?=($keyPhoto == 0 ? ' active' : '')?>" data-entity="slider-control" data-value="<?=$offer['ID'].'_'.$photo['ID']?>">
                                    <img
                                        src="<?=$photo['SRC']?>"
                                        alt="<?=$alt?>"
                                        style="width: 100%; height: 100%; border-radius: 10px; -webkit-object-fit: cover; object-fit: cover; -webkit-object-position: center; object-position: center"
                                    />
                                </div>
                            </div>
                            <? endforeach; ?>
                            ...
                            <? if (!empty($actualItem['MORE_PHOTO'])) { ?>
                                <? foreach ($actualItem['MORE_PHOTO'] as $key => $photo) : ?>
                            <div class="swiper-slide banner-product__small_slide" id="<?=$itemIds['SLIDER_CONT_ID']?>">
                                <div class="d<?=($key == 0 ? ' active' : '')?>" data-entity="slider-control" data-value="<?=$photo['ID']?>">
                                    <img
                                        src="<?=$photo['SRC']?>"
                                        alt="<?=$alt?>"
                                        style="width: 100%; height: 100%; border-radius: 10px; -webkit-object-fit: cover; object-fit: cover; -webkit-object-position: center; object-position: center"
            ...
            <div class="product-content__right">
                ...
                <div class="product-content__right_title"><?=$name?></div>
                <? endif; ?>
        ...
        <div class="product-delivery">
            ...
            <p>Информация о доставке. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
        </div><!-- /product-delivery -->

        <div class="product-about">
            <div class="product-about__tabs" id="<?=$itemIds['TABS_ID']?>">
                ...
                <div class="product-about__content">
                    ...
                    <? if ($showDescription) { ?>
                    <div id="description" class="product-about__content_description" data-entity="tab" data-value="description">
                    ...
                    <div id="characteristic" class="product-about__content_characteristic" data-entity="tab" data-value="properties">
                        <?=$arParams['MESS_PROPERTIES_TAB']?>
                        <p>secendery.Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quaerat velit facilis quis sint quibusdam. Vel consequuntur deleniti necessitatibus enim dolor.</p>
                    </div>
                    <? } ?>
